...
import com.dji.sdk.sample.socket.VideoServer;
...
public class MainContent extends RelativeLayout implements DJIBaseProduct.DJIVersionCallback {
    ...
    private void initUI() {
        ...
        videoServer = VideoServer.getInstance();
    ...
    private void refreshSDKRelativeUI() {
        ...
        if (null != mProduct && mProduct.isConnected()) {
            ...
            mTextConnectionStatus.setText(String.format(Locale.ENGLISH, "Status: %s connected", str));
            mProduct.setDJIVersionCallback(this);
            updateVersion();

            if (null != mProduct.getModel()) {
                mTextProduct.setText(String.format(Locale.ENGLISH, "%s" , mProduct.getModel().getDisplayName()));
            } else {
